...
export const actions = {
  ...
  signOut() {
    // Keep everything local — her plans stay on this device. Also clear
    // guestEntered so the landing goes back to encouraging sign-in, same
    // as a fresh visit, instead of quietly falling back to guest mode.
    setState({ auth: null, guestEntered: false })
  },
